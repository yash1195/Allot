...
//                    geofencingEvent.getErrorCode());
            Log.e(TAG, "GeofenceEvent has error");//errorMessage);
            return;
        }
        ...
        if (geofenceTransition == Geofence.GEOFENCE_TRANSITION_ENTER ||
            ...
            // Log the error.
            Log.e(TAG, "Logging error");//getString(R.string.geofence_transition_invalid_type, geofenceTransition));
        }
    }
    ...
    private void sendNotification(String notificationDetails, Intent intent) {
        ...
        Intent notificationIntent = new Intent(getApplicationContext(), GroupActivity.class);
        ...
        builder.setSmallIcon(R.drawable.logo_allot)
